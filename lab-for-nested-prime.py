...
#
# Ten tekst to definicja pewnego pojęcia. Twoim zadaniem jest zbudowanie streszczenia tej definicji poprzez wyświetlenie
# piewszych 20 słów
...
for definition in definitions:
    ...
    for word in words:
        ...
        if counter >= 20:
            short_definitions.append(short_text)
            break

for short_defonition in short_definitions:
    print(short_defonition)