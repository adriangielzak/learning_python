...
if age >= 18 and not isDrunk:
    print("You are adult and you aren't drunk, so you can buy alkohol")
else:
    print("You can't buy alcohol. Sorry, we cannot sell you alcohol")

isRestrictedArea = False

if age >= 18 and not isDrunk and not isRestrictedArea:
    print("You are adult, you aren't drunk and you aren't in a restricted area so you can buy alkohol")
else:
    print("You can't buy alcohol. Sorry, we cannot sell you alcohol")
...
# który ma na celu zdobywanie "lajków" i "udostępnień" na Facebooku. Jeśli strona firmy otrzyma danego dnia co najmniej
# 500 "lajków" i co najmniej 100 "udostępnień", to ceny spadną o 10%. Na razie masz napisać fragment programu,
# który rozstrzygnie czy warunki promocji są spełnione czy nie. Jeśli już wiesz jak to zrobić "GO ON!", a jeśli chcesz,
# aby Cię trochę pokierować - zajrzyj do kolejnych punktów:
...
# 2.  Pracujesz dla restauracji, która chce nagrodzić klientów zamawiających w dni robocze (poza weekendem) pizze
# lub duży napój. Klienci spełniający warunki promocji dostaną kupon na darmowego burgera. Na razie piszesz polecenie
# decydujące o spełnieniu warunków promocji. Do dyspozycji masz zmienne:
...
# Napisz polecenie IF, które w przypadku, gdy klient kupił pizzę lub duży napój w dzień poza weekendem, wyświetli
# informację o kuponie na Burgera, a w przeciwnym razie wyświetli komunikat zachęcający do dalszych zakupów.
...
if not isWeekend and (isPizzaOrdered or isBigDrinkOrdered):
    ...
    print("Come to us on week day and consider buying Pizza or Big Drink to have Burger for free")
